...
void Sort::std_sort_entries(Entry *entries,const size_t &len){
    std::sort(entries,entries+len);
}
void Sort::bubble_sort_entries(Entry *entries,const size_t &len){
...
void Sort::insert_sort_entries(Entry *entries,const size_t &len){
...
void Sort::msort(Entry *entries,const size_t &a,const size_t &mid,const size_t &b){
    std::vector<int> tmp;
    size_t i = a;
    size_t j = mid + 1;
    for (; (i <= mid) && (j <= b);) {
...
void Sort::merge_sort_entries(Entry *entries,const size_t &a,const size_t &b){
    if (a<b) {
        size_t mid = (a + b) / 2;
...
size_t Sort::qsort(Entry *entries,size_t a,size_t b){
    Entry *mid = &entries[a];
    while (a < b) {
...
void Sort::quick_sort_entries(Entry *entries,const size_t &a,const size_t &b,const bool &flag){
    if(a<b){
...
void Sort::select_sort_entries(Entry *entries,const size_t &len){
...
void Sort::BuildHeap(Entry *entries,const size_t &len){
...
void Sort::MHeapify(Entry *entries,const size_t &pos,const size_t &hsiz){
...
void Sort::heap_sort_entries(Entry *entries,const size_t &len){
...
void Sort::shell_sort_entries(Entry *entries,const size_t &len){
